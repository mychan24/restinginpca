...
gg <- ggplot(mean.fj.bw.supp) + 
  geom_point(aes(`Factor 1`, `Factor 2`), shape="\u25D6", colour="red", size=3) +
geom_point(aes(`Factor 1`, `Factor 2`), shape="\u25D7", colour="blue", size=3) +
...
f_netedge_plot04.5 + theme(text = element_text(family = "Arial Unicode MS")) + geom_point(aes(mean.fj.bw.supp[,1], mean.fj.bw.supp[,2]), shape="\u25D6", colour="red", size=3) +
geom_point(aes(mean.fj.bw.supp[,1], mean.fj.bw.supp[,2]), shape="\u25D7", colour="blue", size=3)
