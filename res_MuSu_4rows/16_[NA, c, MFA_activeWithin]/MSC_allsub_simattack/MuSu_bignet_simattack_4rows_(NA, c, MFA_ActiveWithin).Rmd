...
plot.f_bw_imp.supp <- createFactorMap(mean.fj.bw.supp, axis1 = 1, axis2 = 2,
...
f_netedge_plot04.5 <- plot.f_bw_imp$zeMap_background + plot.f_bw_imp$zeMap_dots + plot.f_bw_imp$zeMap_text + plot.f_bw_imp.supp$zeMap_dots + plot.f_bw_imp.supp$zeMap_text + f.labels
# f_netedge_plot04.5
...
```{r plot_f_edge_cp3, echo=FALSE, fig.show = 'hide'}
# plot all factor scores
plot.f_edge.cp3 <- createFactorMap(mean.fj, axis1 = 2, axis2 = 3,
                               col.points = net.edge.col.bysub$oc,
                               text.cex = 2,
                               force = 0.5,
                               title = "All factor scores - colored by subject_x_edge types")
f_netedge_plot01.cp3 <- plot.f_edge.cp3$zeMap_background + plot.f_edge.cp3$zeMap_dots + f.labels.23

# plot the significantly contributed factor scores
plot.f_edge_imp.cp3 <- createFactorMap(mean.fj, axis1 = 2, axis2 = 3,
                                   col.points = col4ImportantEdg,
                                   col.labels = col4ImportantEdg,
                                   text.cex = 2,
                                   force = 0.5,
                                   title = "Significantly contributed factor scores - colored by subject_x_edge types")
f_netedge_plot02.cp3 <- plot.f_edge_imp.cp3$zeMap_background + plot.f_edge_imp.cp3$zeMap_dots + f.labels.23

# plot only the significant network edges
plot.f_impedge.cp3 <- createFactorMap(mean.fj[importantEdg,], axis1 = 2, axis2 = 3,
                                  col.points = col4ImportantEdg[importantEdg,],
                                  col.labels = col4ImportantEdg[importantEdg,],
                                  constraints = plot.f_edge_imp.cp3$constraints,
                                  text.cex = 2,
                                  force = 0.5,
                                  title = "Significantly contributed factor scores\n(colored by subject_x_edge types)")
f_netedge_plot03.cp3 <- plot.f_impedge.cp3$zeMap + f.labels.23


plot.f_impedge.bynet.cp3 <- createFactorMap(mean.fj[importantEdg,], axis1 = 2, axis2 = 3,
                                  col.points = col4ImportantEdg.bynet[importantEdg,],
                                  col.labels = col4ImportantEdg.bynet[importantEdg,],
                                  constraints = plot.f_edge_imp.cp3$constraints,
                                  text.cex = 2,
                                  force = 0.5,
                                  title = "Significantly contributed factor scores\n(colored by subject_x_edge types)")
f_netedge_plot03.5.cp3 <- plot.f_impedge.bynet.cp3$zeMap + f.labels.23


# plot mean factor scores of subject x edge type
plot.f_bw_imp.cp3 <- createFactorMap(mean.fj.bw, axis1 = 2, axis2 = 3,
                                 col.points = net.edge.col.bysub$gc[rownames(mean.fj.bw),],
                                 col.labels = net.edge.col.bysub$gc[rownames(mean.fj.bw),],
                                 text.cex = 3,
                                 force = 0.5,
                                 title = "Mean factor scores for subject_x_edge types")
f_netedge_plot04.cp3 <- plot.f_bw_imp.cp3$zeMap_background + plot.f_bw_imp.cp3$zeMap_dots + plot.f_bw_imp.cp3$zeMap_text + f.labels
...
plot.f_bw_imp.supp.cp3 <- createFactorMap(mean.fj.bw.supp, axis1 = 2, axis2 = 3,
                                 col.points = net.edge.col.bysub.supp$gc[rownames(mean.fj.bw.supp),],
                                 col.labels = net.edge.col.bysub.supp$gc[rownames(mean.fj.bw.supp),],
                                 text.cex = 3,
                                 force = 0.5,
...
f_netedge_plot04.5.cp3 <- plot.f_bw_imp.cp3$zeMap_background + plot.f_bw_imp.cp3$zeMap_dots + plot.f_bw_imp.cp3$zeMap_text + plot.f_bw_imp.supp.cp3$zeMap_dots + plot.f_bw_imp.supp.cp3$zeMap_text + f.labels
# f_netedge_plot04.5

# plot mean factor scores of network edges
### plot the mean factor scores for network edges
plot.f_edge4pF.cp3 <- createFactorMap(mean.edge.fj[importantCommEdg,],
                                      axis1 = 2, axis2 = 3,
                                  constraints = minmaxHelper4Partial(mean.edge.fj,edge.pF),
                                  text.cex = 3) # with t(gt)


f_netedge_plot05.cp3 <- plot.f_edge4pF.cp3$zeMap + f.labels.23

plot.f_edge4pF.supp.cp3 <- createFactorMap(mean.edge.fj.supp,
                                       axis1 = 2, axis2 = 3,
                                  text.cex = 3) # with t(gt)

f_netedge_plot05.5.cp3 <- plot.f_edge4pF.supp.cp3$zeMap + f.labels.23
f_netedge_plot06.cp3 <- plot.f_edge4pF.cp3$zeMap + plot.f_edge4pF.supp.cp3$zeMap_dots + f.labels.23
```


```{r grid_f_netedge_plot_cp3, echo=F, fig.height=18, fig.width=12}
gridExtra::grid.arrange(as.grob(f_netedge_plot01.cp3), 
                        as.grob(f_netedge_plot02.cp3), 
                        as.grob(f_netedge_plot03.cp3), 
                        as.grob(f_netedge_plot03.5.cp3),
                        as.grob(f_netedge_plot04.cp3), 
                        as.grob(f_netedge_plot04.5.cp3),
                        as.grob(f_netedge_plot05.cp3), 
                        as.grob(f_netedge_plot05.5.cp3),
                        as.grob(f_netedge_plot06.cp3),
                        nrow=3,
                        top = textGrob("Mean factor scores for edges",gp=gpar(fontsize=18,font=3)))
```