---
title: "DoubCent_(NA, c, HMFA--within/between edge-type) - MSC All Subjects (N=10) Big Networks 4 Sessions (rows) - Sim Attack"
...
load(paste0("../../../data/grandatble_and_labels_bignetcol_MSC_allsubs_DC_20190809.Rdata")) # read the labels of grandtable
...
+ Normalizing: hierarchical MFA normalized by *edge types* then subjects 
...
## First
subtab_i <- list(gtlabel$subjects_wb, gtlabel$subjects_label)    # Use subjects_wb as mini table
...
Note that the ALL subjects' EVEN numbered sessions are induced with reduced connectivity in default, default-FP and default-VAN.
...
f_CInetedge_plot02 <- plot.f_impedge$zeMap_background + 
                        f_impedge.CI + plot.f_impedge$zeMap_dots + f.labels
...
save.image(file = "DoubCent_simattack_4rows_11_HMFA-edgeteyp.RData")
```
