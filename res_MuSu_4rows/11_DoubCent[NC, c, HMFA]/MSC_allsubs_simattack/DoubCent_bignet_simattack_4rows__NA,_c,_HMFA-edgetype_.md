DoubCent\_(NA, c, HMFA–within/between edge-type) - MSC All Subjects
(N=10) Big Networks 4 Sessions (rows) - Sim Attack
================
...
##### Method:
  ...
  - Normalizing: hierarchical MFA normalized by *edge types* then
    subjects
...
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/scree-1.png)<!-- -->
...
importantEdg1 <- (absCtrEdg[,1] >= 1/length(cJ[,1]))
importantEdg2 <- (absCtrEdg[,2] >= 1/length(cJ[,2]))
...
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_ciplot-1.png)<!-- -->
...
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/plot_f_sess-1.png)<!-- -->
...
Note that the ALL subjects’ EVEN numbered sessions are induced with
reduced connectivity in default, default-FP and default-VAN.

![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/plot_pf_sess-1.png)<!-- -->
...
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_f_netedge_plot-1.png)<!-- -->
...
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_f_netedgeCI_plot-1.png)<!-- -->
...
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_heat_fi-1.png)<!-- -->

    ## [1] "Dimension 2"

![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_heat_fi-2.png)<!-- -->
...
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_heat_sigfj1-1.png)<!-- -->

Smoothed Sig Factor Score (Dim 1)

Smoothed Node x Node Matrix of Factor Score w/ Sig Contribution: Dim 1
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_smheat_sigfj1-1.png)<!-- -->
...
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_heat_sigfj2-1.png)<!-- -->

Smoothed Sig Factor Score (Dim 2)

Smoothed Node x Node Matrix of Factor Score w/ Sig Contribution: Dim 2
![](DoubCent_bignet_simattack_4rows__NA,_c,_HMFA-edgetype__files/figure-gfm/grid_smheat_sigfj2-1.png)<!-- -->
