---
title: "MuSu_(NA, c, HMFA-edgetype) - MSC All Subjects (N=10) Big Networks 4 Sessions (rows)"
...
+ Normalizing: hierarchical MFA normalized by network edge types (between vs. within) then subjects 
...
## First
subtab_i <-  list(gtlabel$subjects_wb, gtlabel$subjects_label)  # Use subjects_edge_label as mini table
...
save.image(file = "MuSu_bignet_4rows_7_HMFA-edgetype.RData")
```
