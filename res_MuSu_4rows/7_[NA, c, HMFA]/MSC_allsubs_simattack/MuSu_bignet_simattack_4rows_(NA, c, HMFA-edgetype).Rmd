---
title: "MuSu_(NA, c, HMFA-edgetype) - MSC All Subjects (N=10) Big Networks 4 Sessions (rows)- Sim Attack"
...
+ Normalizing: hierarchical MFA normalized by network edge types then subjects 
...
save.image(file = "MuSu_simattack_4rows_7_HMFA-edgeteyp.RData")
```
