---
title: "MuSu_(NA, c, HMFA_sub-edgetype) - MSC All Subjects (N=10) Big Networks 4 Sessions (rows)- Sim Attack (NOT TMS)"
...
* In all *subjects* and Even-numbered *sessions* (2 & 4), Reduce within connectivity in Default Mode (Syslabel: 1), and Increase between connectivity in Default-FP (1_3) and Default_VAN (1_5).
...
+ Normalizing: hierarchical MFA normalized by subjects then by network edge types
...
## First
subtab_i <- list(gtlabel$subjects_label, gtlabel$subjects_wb)  # Use subjects_wb as mini table
...
save.image(file = "MuSu_simattack_NOTMS_4rows_7_HMFA_sub-edgetype.RData")
```
