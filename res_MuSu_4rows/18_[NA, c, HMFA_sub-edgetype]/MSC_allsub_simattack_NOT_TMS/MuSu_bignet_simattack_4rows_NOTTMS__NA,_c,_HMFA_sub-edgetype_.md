MuSu\_(NA, c, HMFA\_sub-edgetype) - MSC All Subjects (N=10) Big Networks
4 Sessions (rows)- Sim Attack (NOT TMS)
================
...
**Attack 1**
  ...
  - In all *subjects* and Even-numbered *sessions* (2 & 4), Reduce
    ...
    between connectivity in Default-FP (1\_3) and Default\_VAN (1\_5).
...
``` r
i_edges_decrease <- which(is.element(gtlabel$edges_label, c("1"))) 

i_edges_increase <- which(is.element(gtlabel$edges_label, c("1_3","1_5"))) 
...
# reduce 50%
gt[seq(2, nrow(gt), 2), i_edges_decrease] <- gt[seq(2, nrow(gt), 2), i_edges_decrease]/2  

# increase x 150%
gt[seq(2, nrow(gt), 2), i_edges_increase] <- gt[seq(2, nrow(gt), 2), i_edges_increase] * 1.5  # reduce 50%
```
...
##### Method:
  ...
  - Normalizing: hierarchical MFA normalized by subjects then by network
    edge types
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/scree-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_ciplot-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/plot_f_sess-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/plot_pf_sess-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_f_netedge_plot-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_f_netedgeCI_plot-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_heat_fi-1.png)<!-- -->

    ## [1] "Dimension 2"

![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_heat_fi-2.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_heat_sigfj1-1.png)<!-- -->

Smoothed Sig Factor Score (Dim 1)

Smoothed Node x Node Matrix of Factor Score w/ Sig Contribution: Dim 1
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_smheat_sigfj1-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_heat_sigfj2-1.png)<!-- -->

Smoothed Sig Factor Score (Dim 2)

Smoothed Node x Node Matrix of Factor Score w/ Sig Contribution: Dim 2
![](MuSu_bignet_simattack_4rows_NOTTMS__NA,_c,_HMFA_sub-edgetype__files/figure-gfm/grid_smheat_sigfj2-1.png)<!-- -->
