---
title: "MuSu_(NA, c, MFA_subXedgetype) - MSC All Subjects (N=10) Big Networks 4 Sessions (rows)- Sim Attack"
...
+ Normalizing: MFA-normalized by network edge types of subjects (e.g., between-sub01, within-sub01, ...)
...
save.image(file = "MuSu_simattack_4rows_7_MFA_subXedgetype.RData")
```
