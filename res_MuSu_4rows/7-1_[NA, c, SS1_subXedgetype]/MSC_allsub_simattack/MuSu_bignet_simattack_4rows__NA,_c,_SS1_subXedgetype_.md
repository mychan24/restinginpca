MuSu\_(NA, c, SS1\_subXedgetype) - MSC All Subjects (N=10) Big Networks
...
##### Method:
  ...
  - Normalizing: Normalized each subjXedgetype sub-table to ss = 1
    (e.g., between-sub01, within-sub01, …)

First we compute the weights that are used to normalized each subject
table. These weights are computed as the inverse of the sums of squares:
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/scree-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_ciplot-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/plot_f_sess-1.png)<!-- -->
...
# compute partial factor scores: K.sub x weight x X_k x Q_k
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/plot_pf_sess-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_f_netedge_plot-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_f_netedgeCI_plot-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_heat_fi-1.png)<!-- -->

    ## [1] "Dimension 2"

![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_heat_fi-2.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_heat_sigfj1-1.png)<!-- -->

Smoothed Sig Factor Score (Dim 1)

Smoothed Node x Node Matrix of Factor Score w/ Sig Contribution: Dim 1
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_smheat_sigfj1-1.png)<!-- -->
...
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_heat_sigfj2-1.png)<!-- -->

Smoothed Sig Factor Score (Dim 2)

Smoothed Node x Node Matrix of Factor Score w/ Sig Contribution: Dim 2
![](MuSu_bignet_simattack_4rows__NA,_c,_SS1_subXedgetype__files/figure-gfm/grid_smheat_sigfj2-1.png)<!-- -->
