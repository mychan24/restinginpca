...
ss_endX
p_s2 <- pheatmap(ss_endX, color = value.col,
         cluster_cols = FALSE, cluster_rows = FALSE,
...
NormSS_endX
p_ns2 <- pheatmap(NormSS_endX, color = value.col,
         cluster_cols = FALSE, cluster_rows = FALSE,
         cellwidth = 35,cellheight = 35,
         annotation_col = data.frame(group = group.des.df[c(1,9,18,27,35),]),
         annotation_row = data.frame(group = group.des.df[c(1,9,18,27,35),]),
...
mean_endX
p_m <- pheatmap(mean_endX, color = value.col,
         cluster_cols = FALSE, cluster_rows = FALSE,
         cellwidth = 35,cellheight = 35,
         annotation_col = data.frame(group = group.des.df[c(1,9,18,27,35),]),
         annotation_row = data.frame(group = group.des.df[c(1,9,18,27,35),]),
...
gridExtra::grid.arrange(as.grob(p_s2), as.grob(p_ns2), as.grob(p_m), ncol=3)
