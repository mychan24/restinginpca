...
# 8/6/2019
# Edited for double-centered data 8/9/2019 by JC
...
#---------For double-centered-------
load(paste0("./data/grandatble_and_labels_MSC_allsubs_DC_20190809.Rdata")) # read the labels of grandtable
#-----------------------------------
...
#---------For double-centered-------
save(file = "./data/grandatble_and_labels_bignetcol_MSC_allsubs_DC_20190809.Rdata", list = c("gt", "gtlabel"))
#-----------------------------------
