...
(Note: These two networks also have strong connections to two other networks, but these connections are not as evenly strong as the O network, and they both have smaller SS.)
...
```
```{r plot_scree, echo = F, fig.width=14, fig.height=5}
