...
labelcol <- list(sub01 = parcel.list$sub01$Comm.col$gc[order(rownames(parcel.list$sub01$Comm.col$gc))],
                 sub02 = parcel.list$sub01$Comm.col$gc[order(rownames(parcel.list$sub01$Comm.col$gc))],
...
textcol <- list(sub01 = c(rep("black",8),rep("white",2),rep("black",3),"white",rep("black",3),rep("white",2)),
                sub02 = c(rep("black",8),rep("white",2),rep("black",3),"white",rep("black",3),rep("white",2)),
...
subj.num <- c("01","02","08")
#--- plot heatmap
for(subj.count in c(1,length(parcel.list))){
...
fi1_s2_sqmat <- vec2sqmat(svd.res$ExPosition.Data$fi[gtlabel$subjects_label=="sub08",1])
...
fi_sub8_sig_sqmat <- vec2sqmat(fi_sig[gtlabel$subjects_label=="sub08",1])
