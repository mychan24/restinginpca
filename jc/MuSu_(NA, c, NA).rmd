...
f_netedge_plot03 <- plot.f_bw_imp$zeMap_background + plot.f_bw_imp$zeMap_dots + plot.f_bw_imp$zeMap_text
...
plot.f_impedge <- createFactorMap(mean.fi[importantEdg,], axis1 = 1, axis2 = 2,
                                   ...
                                   text.cex = 2,
                                   force = 0.5,
                                   title = "Significantly contributed factor scores with bootstrap CI\n (colored by subject_x_edge types)")
# get the bootstrap data for each network edge
getBoot2plot_edge <- BootCube.Comm$BootCube[names(importantEdg[importantEdg]),c(1,2),]
...
f_impedge.CI <- MakeCIEllipses(getBoot2plot_edge,
                                 ...
                                 col = col4ImportantEdg[rownames(getBoot2plot_edge),],
                                 p.level = .95)
# create plot
f_CInetedge_plot01 <- plot.f_impedge$zeMap_background + plot.f_impedge$zeMap_dots + f_impedge.CI
...
plot.CI.f_bw <- MakeCIEllipses(getBoot2plot_edge_bw,
                                 ...
                                 p.level = .95)
# create plot
f_CInetedge_plot02 <- plot.f_bw_imp$zeMap + plot.CI.f_bw
```
