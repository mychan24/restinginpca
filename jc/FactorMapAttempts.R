...
cjplot_show <- createFactorMap(c_edge[which(net.edge %in% edgeOI),],
                               axis1 = 1, axis2 = 2,
                               col.points = col4ImportantEdg[which(net.edge %in% edgeOI)],
                               text.cex = 2,
                               force = 2,
...
fj2plot.ind <- fj.ind[1:round(length(fj.ind)*0.1)]
