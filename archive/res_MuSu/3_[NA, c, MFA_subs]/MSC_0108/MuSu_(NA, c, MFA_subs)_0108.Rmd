...
We can also show the factor scores for network edges as square matrix of sub01 (MSC 01) and sub08 (MSC 08)
...
sm_heat_sigfj2_sub2 <- superheat(fj2_sub2_sig_sqmat, y.axis.reverse = T,
                                 ...
                                 left.label.text.col = textcol$sub08,
                                 bottom.label.text.col = textcol$sub08,
                                 title="Node x Node Matrix of 2nd component factor scores - sub8")
```
