...
![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/plot_sub01_10hmap-1.png)<!-- -->

![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/plot_sub02_10hmap-1.png)<!-- -->
...
##### Method:
  ...
  - Normalizing: MFA-normalized subtable for each subject
...
![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/scree-1.png)<!-- -->
...
![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/grid_ciplot-1.png)<!-- -->
...
![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/plot_f_sess-1.png)<!-- -->
...
![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/plot_pf_sess-1.png)<!-- -->
...
![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/grid_f_netedge_plot-1.png)<!-- -->
...
![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/grid_f_netedgeCI_plot-1.png)<!-- -->

We can also show the factor scores for network edges as square matrix of
sub01 (MSC 01) and sub08 (MSC
08)

![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/grid_heat_fi-1.png)<!-- -->

Factor score (Dim 1) in square matrix that have significant contribution
only

![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/grid_heat_sigfj1-1.png)<!-- -->

Smoothed Sig Factor Score (Dim
1)

![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/grid_smheat_sigfj1-1.png)<!-- -->

Factor score (Dim 2) in square matrix that have significant contribution
only

![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/grid_heat_sigfj2-1.png)<!-- -->

Smoothed Sig Factor Score (Dim
2)

![](MuSu__NA,_c,_MFA_subs__0108_files/figure-gfm/grid_smheat_sigfj2-1.png)<!-- -->
