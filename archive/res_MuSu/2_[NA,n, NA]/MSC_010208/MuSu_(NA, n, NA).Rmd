...
---
title: "MuSu_(NA, n, NA) - MSC01, MSC02, MSC08 (bad sub)"
...
# Center & Normalize Columns (across rows) 
gt_preproc <- expo.scale(gt, center = TRUE, scale = "ss1")# check dimension
gt_preproc[is.nan(gt_preproc)] <- 0
