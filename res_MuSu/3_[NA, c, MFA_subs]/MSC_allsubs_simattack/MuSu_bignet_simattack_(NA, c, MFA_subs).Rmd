...
Note that the odd subjects' odd numbered sessions are induced with reduced connectivity in default, default-FP and default-VAN.
...
gridExtra::grid.arrange(as.grob(f_netedge_plot01), as.grob(f_netedge_plot02),as.grob(f_netedge_plot03),as.grob(f_netedge_plot04), as.grob(f_netedge_plot05),nrow=2,
