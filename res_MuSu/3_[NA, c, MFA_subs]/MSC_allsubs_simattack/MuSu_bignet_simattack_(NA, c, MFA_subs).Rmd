---
title: "MuSu_(NA, c, MFA_subs) - MSC All Subjects (N=10) Big Networks - Sim Attack"
...
# Plot factor scores
plot.f_sess <- createFactorMap(svd.res$ExPosition.Data$fi, axis1 = 1, axis2 = 2)
...
plot.f_sess4pF <- createFactorMap(svd.res$ExPosition.Data$fi[seq(1,10,1),],
...
plot.pf_sess <- createPartialFactorScoresMap(
  ...
  factorScores = svd.res$ExPosition.Data$fi[seq(1,10,1),],
  partialFactorScores = pFi[seq(1,10,1),,],
  axis1 = 1, axis2 = 2,
