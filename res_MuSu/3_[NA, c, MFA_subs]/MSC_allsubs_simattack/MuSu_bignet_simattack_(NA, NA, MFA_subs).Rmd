---
title: "MuSu_(NA, NA, MFA_subs) - MSC All Subjects (N=10) Big Networks - Sim Attack"
...
parcelfile2read <- c("/sub-MSC01_node_parcel_bigcomm.txt",
                     "/sub-MSC02_node_parcel_bigcomm.txt",
                     "/sub-MSC03_node_parcel_bigcomm.txt",
                     "/sub-MSC04_node_parcel_bigcomm.txt",
                     "/sub-MSC05_node_parcel_bigcomm.txt",
                     "/sub-MSC06_node_parcel_bigcomm.txt",
                     "/sub-MSC07_node_parcel_bigcomm.txt",
                     "/sub-MSC08_node_parcel_bigcomm.txt",
                     "/sub-MSC09_node_parcel_bigcomm.txt",
                     "/sub-MSC10_node_parcel_bigcomm.txt"
)
...
**Attack 1**
* In Odd-numbered *subjects* and *sessions*, Reduce within connectivity in Default Mode (Syslabel: 1), Default-FP (1_3) and Default_VAN (1_5).

**Attack 2**
* In Even-numbered *subjects* and *sessions*, Reduce within connectivity in Default Mode (Syslabel: 1), Default-FP (1_3) and Default_VAN (1_5).
...
CommName[,'Community'] <- sapply(CommName$CommLabel, FUN = function(x){strsplit(as.character(x), split = "_")[[1]][2]})
...
MYC: only show the odd numbered sessions' partial factor score. Note that the odd# subjects' odd# sessions are induced with reduced connectivity in default, default-FP and default-VAN.
...
plot.f_sess4pF <- createFactorMap(svd.res$ExPosition.Data$fi[seq(1,10,2),],
...
plot.pf_sess <- createPartialFactorScoresMap(
  ...
  factorScores = svd.res$ExPosition.Data$fi[seq(1,10,2),],
  partialFactorScores = pFi[seq(1,10,2),,],
  axis1 = 1, axis2 = 2,
