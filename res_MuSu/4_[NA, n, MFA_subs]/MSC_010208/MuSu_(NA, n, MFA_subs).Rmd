...
for(i in 1:length(subj.name)){
  ...
  textcol[[i]][as(hex2RGB(labelcol[[i]]), "polarLUV")@coords[,1] < 35] <- "white"  # Convert hex2RGB to lum
}
...
# read examplar data
zmat.path <- "../../../data/zmat"
subj.num <- csubstr(subj.name, start = 4, stop = 6) # only works with format like "sub06" or "MSC06"
#--- plot heatmap
