...
Factor score 1 in squarem matrix that have significant contribution only

![](MuSu__NA,_n,_MFA_subs__files/figure-markdown_github/grid_heat_sigfi1-1.png)

Smoothed Sig Factor Score 1

![](MuSu__NA,_n,_MFA_subs__files/figure-markdown_github/grid_smheat_sigfi1-1.png)

Factor score 2 in squarem matrix that have significant contribution only

![](MuSu__NA,_n,_MFA_subs__files/figure-markdown_github/grid_heat_sigfi2-1.png)

Smoothed Sig Factor Score 2

![](MuSu__NA,_n,_MFA_subs__files/figure-markdown_github/grid_smheat_sigfi2-1.png)
