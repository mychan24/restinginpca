...
eigens <- matrix(NA, 1, n_subtable)     # Initialize eigenvalues object

for(i in 1:n_subtable){
  eigens[i] <- (svd(cgt[,subtab_il==unique(subtab_i)[i]])$d[1])^2 # square singular value from svd 
}
...
#--- color for sessions
col4ImportantSes <- as.matrix(rep("mediumorchid4",nrow(cJ))) # get colors
...
fi1_s2_sqmat <- vec2sqmat(svd.res$ExPosition.Data$fi[gtlabel$subjects_label=="sub02",1])

fi2_s1_sqmat <- vec2sqmat(svd.res$ExPosition.Data$fi[gtlabel$subjects_label=="sub01",2])
fi2_s2_sqmat <- vec2sqmat(svd.res$ExPosition.Data$fi[gtlabel$subjects_label=="sub02",2])

heat_fi1_s1 <- superheat(fi1_s1_sqmat, y.axis.reverse = T,
                    membership.rows =parcel.list$sub01$vox.des$Comm.rcd,
                    membership.cols =parcel.list$sub01$vox.des$Comm.rcd,                    
                    left.label.col = labelcol$sub01,
                    bottom.label.col = labelcol$sub01,
...
heat_fi1_s2 <- superheat(fi1_s2_sqmat, y.axis.reverse = T,
...
heat_fi2_s1 <- superheat(fi2_s1_sqmat, y.axis.reverse = T,
                    membership.rows =parcel.list$sub01$vox.des$Comm.rcd,
                    membership.cols =parcel.list$sub01$vox.des$Comm.rcd,                    
                    left.label.col = labelcol$sub01,
                    bottom.label.col = labelcol$sub01,
...
heat_fi2_s2 <- superheat(fi2_s2_sqmat, y.axis.reverse = T,
                    membership.rows =parcel.list$sub02$vox.des$Comm.rcd,
                    membership.cols =parcel.list$sub02$vox.des$Comm.rcd,                    
                    left.label.col = labelcol$sub02,
                    bottom.label.col = labelcol$sub02,
...
gridExtra::grid.arrange(as.grob(heat_fi1_s1$plot), as.grob(heat_fi1_s2$plot), 
                        as.grob(heat_fi2_s1$plot), as.grob(heat_fi2_s2$plot), 
                        ncol=2,
...
```{r, squaremat_sigfi1, echo=F, fig.show = 'hide'}
fi_sig <- svd.res$ExPosition.Data$fi
fi_sig[!importantEdg1] <- 0
fi1_sub1_sig_sqmat <- vec2sqmat(fi_sig[gtlabel$subjects_label=="sub01",1])
fi1_sub2_sig_sqmat <- vec2sqmat(fi_sig[gtlabel$subjects_label=="sub02",1])

heat_sigfi1_sub1 <- superheat(fi1_sub1_sig_sqmat, y.axis.reverse = T,
                             membership.rows =parcel.list$sub01$vox.des$Comm.rcd,
                             membership.cols =parcel.list$sub01$vox.des$Comm.rcd,                    
                             left.label.col = labelcol$sub01,
                             bottom.label.col = labelcol$sub01,
...
heat_sigfi1_sub2 <- superheat(fi1_sub2_sig_sqmat, y.axis.reverse = T,
                             membership.rows =parcel.list$sub02$vox.des$Comm.rcd,
                             membership.cols =parcel.list$sub02$vox.des$Comm.rcd,
                             left.label.col = labelcol$sub02,
                             bottom.label.col = labelcol$sub02,
...
```{r, grid_heat_sigfi1, echo=F, fig.height=8, fig.width=14}
gridExtra::grid.arrange(as.grob(heat_sigfi1_sub1$plot), as.grob(heat_sigfi1_sub2$plot), 
                        ncol=2,
...
```{r, sm_squaremat_sigfi1, echo=F, fig.show = 'hide'}
#--- the important variables are the ones that contribute more than or equal to the average
sm_heat_sigfi1_sub1 <- superheat(fi1_sub1_sig_sqmat, y.axis.reverse = T, 
...
sm_heat_sigfi1_sub2 <- superheat(fi1_sub2_sig_sqmat, y.axis.reverse = T,
                                smooth.heat = T, smooth.heat.type = "mean",
                                membership.rows =parcel.list$sub02$vox.des$Comm.rcd,
                                membership.cols =parcel.list$sub02$vox.des$Comm.rcd,
                                left.label.col = labelcol$sub02,
...
```{r, grid_smheat_sigfi1, echo=F, fig.height=8, fig.width=14}
gridExtra::grid.arrange(as.grob(sm_heat_sigfi1_sub1$plot), as.grob(sm_heat_sigfi1_sub2$plot), 
                        ncol=2,
...
```{r, squaremat_sigfi2, echo=F, fig.show = 'hide'}
fi2_sub1_sig_sqmat <- vec2sqmat(fi_sig[gtlabel$subjects_label=="sub01",2])
fi2_sub2_sig_sqmat <- vec2sqmat(fi_sig[gtlabel$subjects_label=="sub02",2])

heat_sigfi2_sub1 <- superheat(fi2_sub1_sig_sqmat, y.axis.reverse = T,
                             membership.rows =parcel.list$sub01$vox.des$Comm.rcd,
                             membership.cols =parcel.list$sub01$vox.des$Comm.rcd,                    
                             left.label.col = labelcol$sub01,
                             bottom.label.col = labelcol$sub01,
...
heat_sigfi2_sub2 <- superheat(fi2_sub2_sig_sqmat, y.axis.reverse = T,
                             membership.rows =parcel.list$sub02$vox.des$Comm.rcd,
                             membership.cols =parcel.list$sub02$vox.des$Comm.rcd,
                             left.label.col = labelcol$sub02,
                             bottom.label.col = labelcol$sub02,
...
```{r, grid_heat_sigfi2, echo=F, fig.height=8, fig.width=14}
gridExtra::grid.arrange(as.grob(heat_sigfi2_sub1$plot), as.grob(heat_sigfi2_sub2$plot), 
                        ncol=2,
...
```{r, sm_squaremat_sigfi2, echo=F, fig.show = 'hide'}
#--- the important variables are the ones that contribute more than or equal to the average
sm_heat_sigfi2_sub1 <- superheat(fi2_sub1_sig_sqmat, y.axis.reverse = T, 
                                smooth.heat = T, smooth.heat.type = "mean",
                                membership.rows =parcel.list$sub01$vox.des$Comm.rcd,
                                membership.cols =parcel.list$sub01$vox.des$Comm.rcd,                    
                                left.label.col = labelcol$sub01,
...
sm_heat_sigfi2_sub2 <- superheat(fi2_sub2_sig_sqmat, y.axis.reverse = T,
                                smooth.heat = T, smooth.heat.type = "mean",
                                membership.rows =parcel.list$sub02$vox.des$Comm.rcd,
                                membership.cols =parcel.list$sub02$vox.des$Comm.rcd,
                                left.label.col = labelcol$sub02,
...
```{r, grid_smheat_sigfi2, echo=F, fig.height=8, fig.width=14}
gridExtra::grid.arrange(as.grob(sm_heat_sigfi2_sub1$plot), as.grob(sm_heat_sigfi2_sub2$plot), 
                        ncol=2,
