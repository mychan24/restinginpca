DoubleCent\_(NA, NA, MFA\_subs) - MSC All Subjects (N=10)
================
...
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/scree-1.png)<!-- -->
...
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_ciplot-1.png)<!-- -->
...
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/plot_f_sess-1.png)<!-- -->
...
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_f_netedge_plot-1.png)<!-- -->
...
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_f_netedgeCI_plot-1.png)<!-- -->
...
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_heat_fi-1.png)<!-- -->

    ## [1] "Dimension 2"

![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_heat_fi-2.png)<!-- -->
...
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_heat_sigfj1-1.png)<!-- -->

Smoothed Sig Factor Score (Dim 1)

Smoothed Node x Node Matrix of Factor Score w/ Sig Contribution: Dim 1
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_smheat_sigfj1-1.png)<!-- -->
...
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_heat_sigfj2-1.png)<!-- -->

Smoothed Sig Factor Score (Dim 2)

Smoothed Node x Node Matrix of Factor Score w/ Sig Contribution: Dim 2
![](DoubleCent__NA,_NA,_MFA_subs__files/figure-gfm/grid_smheat_sigfj2-1.png)<!-- -->
