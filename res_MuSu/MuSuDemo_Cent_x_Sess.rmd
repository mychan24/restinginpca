...
gridExtra::grid.arrange(as.grob(heats_fi1$plot), as.grob(heats_fi2$plot), ncol=2,
...
gridExtra::grid.arrange(as.grob(heats_sig_fi1$plot), as.grob(heats_sig_fi2$plot), ncol=2,
