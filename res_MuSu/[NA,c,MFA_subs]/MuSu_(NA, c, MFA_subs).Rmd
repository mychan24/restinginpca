...
mfa_preproc <- mpSTATIS.preprocess(data = gt, column.design = as.matrix(t(gtlabel$subjects_label)), row.design = NULL, 
                    row.preprocess = 'None', column.preprocess = 'Center', 
...
heats2 <- superheat(fi1_s2_sqmat, y.axis.reverse = T,
...
gridExtra::grid.arrange(as.grob(heats1$plot), as.grob(heats2$plot), 
                        ncol=2,
...
fi_sub2_sig_sqmat <- vec2sqmat(fi_sig[gtlabel$subjects_label=="sub02",1])
...
heat_sigfi_sub2 <- superheat(fi_sub2_sig_sqmat, y.axis.reverse = T,
                             membership.rows =parcel.list$sub02$vox.des$Comm.rcd,
                             membership.cols =parcel.list$sub02$vox.des$Comm.rcd,
                             left.label.col = labelcol$sub02,
                             bottom.label.col = labelcol$sub02,
...
gridExtra::grid.arrange(as.grob(heat_sigfi_sub1$plot), as.grob(heat_sigfi_sub2$plot), 
                        ncol=2,
...
sm_heat_sigfi_sub2 <- superheat(fi_sub2_sig_sqmat, y.axis.reverse = T,
                                smooth.heat = T, smooth.heat.type = "mean",
                                membership.rows =parcel.list$sub02$vox.des$Comm.rcd,
                                membership.cols =parcel.list$sub02$vox.des$Comm.rcd,
                                left.label.col = labelcol$sub02,
...
gridExtra::grid.arrange(as.grob(sm_heat_sigfi_sub1$plot), as.grob(sm_heat_sigfi_sub2$plot), 
                        ncol=2,
